...
CVoid CGUIButton::Render(CBool selectionMode)
{
	...
	if (g_currentCameraType == eCAMERA_DEFAULT_PHYSX && m_currentImageType == eBUTTON_IMAGE_LEFT_CLICK)
	{
	...
	else if (g_currentCameraType == eCAMERA_DEFAULT_PHYSX && m_currentImageType == eBUTTON_IMAGE_RIGHT_CLICK)
	{
