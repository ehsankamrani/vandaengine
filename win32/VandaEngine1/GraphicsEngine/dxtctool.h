...
inline void dxtc_pixels::BVF_Alpha_DXT5_H4(void * const pBlock) const {
	...
	__int64 TmpQWord = (pB[0] & 0x000000000000FFFF);
	TmpQWord |= (pB[0] & 0x000000000FFF0000) << 36;
	TmpQWord |= (pB[0] & 0x000000FFF0000000) << 12;
	TmpQWord |= (pB[0] & 0x000FFF0000000000) >> 12;
	TmpQWord |= (pB[0] & 0xFFF0000000000000) >> 36;
	pB[0] = TmpQWord;
}
...
inline void dxtc_pixels::BVF_Alpha_DXT5(void * const pBlock1, void * const pBlock2) const {
	...
	__int64 TmpQWord1 = (pB1[0] & 0x000000000000FFFF);
	TmpQWord1 |= (pB1[0] & 0x000000000FFF0000) << 36;
	TmpQWord1 |= (pB1[0] & 0x000000FFF0000000) << 12;
	TmpQWord1 |= (pB1[0] & 0x000FFF0000000000) >> 12;
	TmpQWord1 |= (pB1[0] & 0xFFF0000000000000) >> 36;

	__int64 TmpQWord2 = (pB2[0] & 0x000000000000FFFF);
	TmpQWord2 |= (pB2[0] & 0x000000000FFF0000) << 36;
	TmpQWord2 |= (pB2[0] & 0x000000FFF0000000) << 12;
	TmpQWord2 |= (pB2[0] & 0x000FFF0000000000) >> 12;
	TmpQWord2 |= (pB2[0] & 0xFFF0000000000000) >> 36;
