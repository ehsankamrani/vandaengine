...
{
	g_main->m_soundSystem->StopALSound(*(m_walkSound->GetSoundSource()));
	g_main->m_soundSystem->StopALSound(*(m_runSound->GetSoundSource()));
	g_main->m_soundSystem->StopALSound(*(m_jumpSound->GetSoundSource()));
