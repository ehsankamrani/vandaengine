...
BOOL CScriptUtilityPrefabInstances::OnInitDialog()
{
	...
	m_prefabImageList.Create(32, 32, ILC_COLOR24, 1, 1);
	cBmp.LoadBitmap(IDB_BITMAP_SCRIPT_UTILITY_PREFAB);
	m_prefabImageList.Add(&cBmp, cBmpMask);
	cBmp.DeleteObject();
	m_listPrefabInstanceNames.SetImageList(&m_prefabImageList, LVSIL_SMALL);
	...
	m_animationImageList.Create(32, 32, ILC_COLOR24, 1, 1);
	cBmp.LoadBitmap(IDB_BITMAP_SCRIPT_UTILITY_ANIMATION);
	m_animationImageList.Add(&cBmp, cBmpMask);
	cBmp.DeleteObject();
	m_listPrefabInstanceAnimationNames.SetImageList(&m_animationImageList, LVSIL_SMALL);
	...
	m_cameraImageList.Create(32, 32, ILC_COLOR24, 1, 1);
	cBmp.LoadBitmap(IDB_BITMAP_SCRIPT_UTILITY_CAMERA);
	m_cameraImageList.Add(&cBmp, cBmpMask);
	cBmp.DeleteObject();
	m_listPrefabInstanceCameraNames.SetImageList(&m_cameraImageList, LVSIL_SMALL);
