...
void CAddMainCharacter::OnBnClickedButtonSelectCharacter()
{
	...
	if (result == IDOK)
	{
		...
		ex_pVandaEngineDlg->m_dlgPrefabs = CNew(CPrefabDlg);
		ex_pDlgPrefabs = ex_pVandaEngineDlg->m_dlgPrefabs;
		ex_pVandaEngineDlg->OnMenuClickedInsertPrefab(NULL, g_currentPrefabPackageName, g_currentPrefabName);
		...
		CDelete(ex_pVandaEngineDlg->m_dlgPrefabs);
...
void CAddMainCharacter::OnBnClickedOk()
{
	...
	else
	{
		...
		ex_pVandaEngineDlg->m_dlgPrefabs = CNew(CPrefabDlg);
		ex_pDlgPrefabs = ex_pVandaEngineDlg->m_dlgPrefabs;
		ex_pVandaEngineDlg->OnMenuClickedInsertPrefab(NULL, g_mainCharacter->GetPackageName(), g_mainCharacter->GetPrefabName());
