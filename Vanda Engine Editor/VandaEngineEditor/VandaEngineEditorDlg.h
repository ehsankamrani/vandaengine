...
struct CVSceneObjectNames
{
	...
	std::vector<std::string> m_engineVideoNames; //Video names of this VScene
...
class CVandaEngineDlg : public CDialog
{
// Construction
public:
	CVandaEngineDlg(CWnd* pParent = NULL);	// standard constructor
	~CVandaEngineDlg();
// Dialog Data
...
public:
	...
	CVoid ChangeVideoProperties(CVideo* video);
...
public:
	...
	std::vector<std::string> m_deletedVideoObjects;
...
public:
	afx_msg BOOL CVandaEngineDlg::PreTranslateMessage(MSG* pMsg);
public:
...
//	afx_msg void OnHdnItemclickListScenes(NMHDR *pNMHDR, LRESULT *pResult);
	...
	CCustomBitmapButton m_mainBtnDeactivatePlayMode;
	CCustomBitmapButton m_mainBtnActivatePlayMode;
	afx_msg void OnBnClickedBtnDeactivatePlayMode();
	afx_msg void OnBnClickedBtnActivatePlayMode();
...
extern CVandaEngineDlg* ex_pVandaEngineDlg;
...
extern CButton* ex_pBtnDeactivatePlayMode;
extern CButton* ex_pBtnActivatePlayMode;
