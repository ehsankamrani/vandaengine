...
BOOL CScriptUtilityGUIs::OnInitDialog()
{
	...
	m_guiImageList.Create(32, 32, ILC_COLOR24, 1, 1);
	cBmp.LoadBitmap(IDB_BITMAP_SCRIPT_UTILITY_GUI);
	m_guiImageList.Add(&cBmp, cBmpMask);
	cBmp.DeleteObject();
	...
	m_listGUI.SetImageList(&m_guiImageList, LVSIL_SMALL);
