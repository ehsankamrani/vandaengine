...
class CEditImportOptions : public CDialog
{
	DECLARE_DYNAMIC(CEditImportOptions)

public:
	CEditImportOptions(CWnd* pParent = NULL);   // standard constructor
	virtual ~CEditImportOptions();
