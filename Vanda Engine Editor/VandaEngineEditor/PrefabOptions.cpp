...
IMPLEMENT_DYNAMIC(CPrefabOptions, CDialog)

CPrefabOptions::CPrefabOptions(CWnd* pParent /*=NULL*/)
	: CDialog(CPrefabOptions::IDD, pParent)
{
	m_updateScript = CFalse;
	m_hasScript = CFalse;
}

CPrefabOptions::~CPrefabOptions()
{
}

void CPrefabOptions::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CPrefabOptions, CDialog)
	ON_CBN_SELCHANGE(IDC_COMBO_ANIMATION_CLIP, &CPrefabOptions::OnCbnSelchangeComboAnimationClip)
	ON_BN_CLICKED(IDC_BTN_ADD_PREFAB_SCRIPT, &CPrefabOptions::OnBnClickedBtnAddPrefabScript)
	ON_BN_CLICKED(IDC_BTN_REMOVE_PREFAB_SCRIPT, &CPrefabOptions::OnBnClickedBtnRemovePrefabScript)
	ON_BN_CLICKED(IDC_BUTTON_COPY_ANIMATION, &CPrefabOptions::OnBnClickedButtonCopyAnimation)
	ON_BN_CLICKED(IDC_BUTTON_VIEW_SCRIPT, &CPrefabOptions::OnBnClickedButtonViewScript)
END_MESSAGE_MAP()


// CPrefabOptions message handlers

BOOL CPrefabOptions::OnInitDialog()
{
...
void CPrefabOptions::OnCbnSelchangeComboAnimationClip()
{
...
void CPrefabOptions::OnBnClickedBtnAddPrefabScript()
{
...
void CPrefabOptions::OnBnClickedBtnRemovePrefabScript()
{
	if (!m_hasScript)
	{
...
void CPrefabOptions::OnBnClickedButtonCopyAnimation()
{
	CString s;
...
void CPrefabOptions::OnBnClickedButtonViewScript()
{
	if (!m_hasScript)
	{
