...
public:
	...
	MySoftBody(NxScene *scene, NxSoftBodyDesc &desc, char *tetFileName, ObjMesh *surfaceMesh, NxReal scale = 1.0f);
	/* regular mesh */
...
private:
	...
	bool generateTetMeshDesc(NxSoftBodyMeshDesc &desc, char *filename, NxReal scale = 1.0f);
